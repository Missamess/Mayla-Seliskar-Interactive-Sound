...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 152.603485107421875, 3.0, 9.742591857910156, 9.742591857910156 ],
					"rounded" : 15.0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 90.3460693359375, 47.792236328125, 60.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"activedialcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1.474807977676392, 16.0, 60.0, 21.0 ],
					"text" : "MIXFADR",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 104.0, 3.0, 9.742591857910156, 9.742591857910156 ],
					"rounded" : 15.0,
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 38.871292114257812, 0.0, 40.0, 17.0 ],
					"text" : "Video2",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 23.217376708984375, 68.792236328125, 62.0, 20.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.474808007478714, 15.783485412597656, 168.0, 19.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
							"parameter_initial" : [ 1 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 23.217376708984375, 47.792236328125, 51.0, 18.0 ],
					"text" : "Operation"
				}
